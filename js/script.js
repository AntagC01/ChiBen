document.addEventListener("DOMContentLoaded", () => {
    ...
    function exportsave() {
        ...
        // XOR
        const xorData = xorEncryptDecrypt(cookies, XOR_KEY);

        // Base64 (para poder salvar em TXT)
        const encoded = btoa(xorData);
    ...
    function importsave() {
        ...
        reader.onload = function (e) {
            ...
            try {
                // Base64 → texto original XOR
                conteudo = atob(conteudo);

                // XOR → texto original
                conteudo = xorEncryptDecrypt(conteudo, XOR_KEY);
            } catch (err) {
